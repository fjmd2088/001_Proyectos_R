...
for(i in 1:length(tribunales)){
  # i <- 1
  ind <- which(AUX$`Nombre del órgano jurisdiccional` == tribunales[i])
  AUX$ordenar[ind] <- i
}
...
write.xlsx(HOJA_INGRESOS,paste0(dir_res_ed,"HOJA_INGRESOS_",name_file,"_",ANIO,".xlsx"))